...
public class Bag {
	...
	public static  void AddLettersToBag(ArrayList<String> letters) {
		letters.add("a" );
		letters.add("b" );
		letters.add("c" );
		letters.add("d" );
	...
	public static String GetALetter()
	{
		AddLettersToBag(letters);
		Random LetterRandom = new Random();
		int ValLetter  = LetterRandom.nextInt(26 - 0 + 1) + 0;
		String LetterValue ;
